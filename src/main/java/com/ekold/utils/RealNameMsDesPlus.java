...
public class RealNameMsDesPlus {
    ...
    //test
//    private static String strDefaultKey = "jXdI~$P";

    //prod
    private static String strDefaultKey = "qwZUHW#";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String txt1 = desPlus.encrypt("17866950538");
        System.out.println(txt1);
//        System.out.println(desPlus.decrypt("8e521d954ada7e3cab55628d1cabb6ea"));

        String txt2 = desPlus.encrypt("SDZT");
        System.out.println(txt2);
//        System.out.println(desPlus.decrypt("ac5096f4a5a4b907"));
    }
